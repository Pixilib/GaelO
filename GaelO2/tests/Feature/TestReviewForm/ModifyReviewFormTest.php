...
class ModifyReviewFormTest extends TestCase
{
    ...
    public function testModifyReviewForm()
    {
        ...
        $this->trackerSpy->shouldHaveReceived('writeAction')->once()->with($currentUserId, Constants::ROLE_REVIEWER, Mockery::any(), Mockery::any(), Constants::TRACKER_MODIFY_REVIEWER_FORM, Mockery::any());
    }
