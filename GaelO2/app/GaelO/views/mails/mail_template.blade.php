...
<html lang="en">
<head>
    <title>GaelO Imaging Platform Notification</title>
</head>
                            ...
                            <table class="content content_wrapper" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div
                                            style="font-family: helvetica, sans-serif; color: #314053; font-size: 16px; line-height: 1.6; margin-top: 0; margin-bottom: 40px;">
                                            @yield('content')</div>
                                        ...
                                        <div
                                            ...
                                            questions <a
                                                style="font-family: helvetica, sans-serif; color: #314053; font-size: 16px; line-height: 1.6; text-decoration: underline;"
                        ...
                        <td bgcolor="#f7f7f7">
                            <table class="content" align="center" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td align="center">
                                        <div
                                            style="font-family: helvetica, sans-serif; color: #314053; font-size: 18px; margin-top: 10px; margin-bottom: 10px;">
                                            <a style="font-family: helvetica, sans-serif; color: #314053; font-size: 18px; text-decoration: none;"
                                                href="{{ $webAddress }}"><strong>{{ $webAddress }}</strong></a>
                                        </div>
                                        <div
                                            style="font-family: helvetica, sans-serif; color: #314053; font-size: 14px; margin-top: 0px; margin-bottom: 80px; font-style: italic;">
