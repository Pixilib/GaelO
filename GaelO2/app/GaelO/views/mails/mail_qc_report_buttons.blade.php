                          ...
                          <tbody>
                            <tr>
                              <td align="center" bgcolor="#2ec086" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#2ec086;" valign="middle">
                                <a href="{{ $magicLink }}" rel="noopener" style="display:inline-block;background:#2ec086;color:#FFFFFF;font-family:Roboto, Helvetica, sans-serif;font-size:14px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;" target="_blank"> Access QC </a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
