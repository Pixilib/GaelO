    ...
    @if (!empty($visitId) && !empty($study))
        ...
        <div style="font-family: helvetica; font-size: 14px; margin-top: 0; margin-bottom: 20px">
            <a href="{{ $webAddress }}/study/{{ $study }}/role/Investigator/visit/{{ $visitId }}"
                ...
                style="display: inline-block; color: #FFBA4D; font-family: helvetica; font-size: 14px; padding: 10px 8px; border: 1px solid #FFBA4D; border-radius: 50px; text-decoration: none; margin-right: 17px; margin-bottom: 10px;"><strong>Monitor</strong></a><a
                href="{{ $webAddress }}/study/{{ $study }}/role/Controller/visit/{{ $visitId }}"
                style="display: inline-block; color: #353275; font-family: helvetica; font-size: 14px; padding: 10px 8px; border: 1px solid #353275; border-radius: 50px; text-decoration: none; margin-right: 17px; margin-bottom: 10px;"><strong>Controller</strong></a><a
