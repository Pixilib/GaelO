                      ...
                      <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;text-align:center;">
                          ...
                          <div class="mj-column-per-100 mj-outlook-group-fix"
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                  ...
                                  <tbody>
                                      <tr>
                                          <td align="center" class="text-color"
                                      ...
                                      <tr>
                                          <td align="center"
                                              style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                              <div
                                                  style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:16px;text-align:center;color:#000000;">
                                                  Registation Date : {{ $studyInfo['registrationDate'] }}<br> Visit Date
                                                  Expected After : {{ $studyInfo['minVisitDate'] }}<br> Visit Date
                                                  Expected Before : {{ $studyInfo['maxVisitDate'] }}<br> Visit Date:
                                                  {{ $studyInfo['visitDate'] }}</div>
                                          </td>
                                      </tr>
                                  </tbody>
                              </table>
                      ...
                      <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                                  ...
                                  <tbody>
                                      <tr>
                                          <td align="center"
                                              style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                              <p
                                                  style="border-top:solid 1px #616161;font-size:1px;margin:0px auto;width:100%;">
                                              </p>
                          ...
                          <div class="mj-column-per-100 mj-outlook-group-fix"
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                  ...
                                  <tbody>
                                      <tr>
                                          <td align="left" class="table-striped"
                                              style="font-size:0px;padding:10px 25px;word-break:break-word;">
