...
class GetAssociatedFilesForReview
{
    ...
    public function execute(GetAssociatedFilesForReviewRequest $getAssociatedDataForReviewRequest, GetAssociatedFilesForReviewResponse $getAssociatedDataForReviewResponse)
    {
        try {
            ...
            $associatedFile = $this->reviewFormService->getVisitDecisionObject()->getAssociatedFilesForReviewForm();

            $getAssociatedDataForReviewResponse->body = $associatedFile;
