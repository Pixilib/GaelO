...
class GetAssociatedFilesForInvestigator
{
    ...
    public function execute(GetAssociatedFilesForInvestigatorRequest $getAssociatedDataForInvestigatorRequest, GetAssociatedFilesForInvestigatorResponse $getAssociatedDataForInvestigatorResponse)
    {
        try {
            ...
            $associatedData = $this->investigatorFormService->getVisitDecisionObject()->getAssociatedFilesForInvestigatorForm();
