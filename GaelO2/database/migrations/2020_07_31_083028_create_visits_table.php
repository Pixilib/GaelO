...
class CreateVisitsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('visits', function (Blueprint $table) {
            ...
            $table->string('status_done', ['Not Done','Done'])->nullable(false)->default('Not Done');
            $table->string('reason_for_not_done', 256)->nullable(true)->default(null);
            $table->string('upload_status', ['Not Done','Processing','Done'])->nullable(false)->default('Not Done');
            $table->string('state_investigator_form', ['Not Done', 'Not Needed', 'Draft', 'Done'])->nullable(false)->default('Not Done');
            $table->string('state_quality_control', ['Not Done', 'Not Needed', 'Wait Definitive Conclusion','Corrective Action Asked','Refused','Accepted'])->nullable(false)->default('Not Done');
