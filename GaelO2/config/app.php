...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Minimal Onboarding Version
    |--------------------------------------------------------------------------
    |
    | Minimal onboarding version user should have validated to access GaelO
    */
    ...
    */
    ...
    'gaelo_wsi_processing_url' => env('GAELO_WSI_PROCESSING_URL', ''),
    'gaelo_wsi_processing_login' => env('GAELO_WSI_PROCESSING_LOGIN', ''),
    'gaelo_wsi_processing_password' => env('GAELO_WSI_PROCESSING_PASSWORD', ''),
