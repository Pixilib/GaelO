...
class VisitService
{
    ...
    string $statusDone, ?string $reasonForNotDone) {
        ...
        $this->visitRepository->createVisit($creatorUserId, $patientCode, $acquisitionDate, $visitTypeId,
         $statusDone, $reasonForNotDone, $stateInvestigatorForm, $stateQualityControl);
    }
