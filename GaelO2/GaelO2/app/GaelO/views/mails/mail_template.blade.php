                    ...
                    <tr>
                        <td bgcolor="#ffffff">
                            <table class="content content_wrapper" align="center" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; padding: 32px 30px;">
                                <tr>
                                    <td>
                                        <p style="font-family: helvetica; color: #314053; font-size: 16px; line-height: 1.6; margin-top: 0; margin-bottom: 20px;">
                                            <strong>Dear {{ $name ?? "User" }},</strong>
                                        </p>
                                        <p style="font-family: helvetica; color: #314053; font-size: 16px; line-height: 1.6; margin-top: 0; margin-bottom: 40px;">
                                            @yield('content')</p>
                    ...
                    <tr>
                        <td bgcolor="#f7f7f7">
                            <table class="content" align="center" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin:0 auto; line-height: 1.3; padding: 18px">
                                <tr>
                                    <td align="center">
                                        <p style="font-family: helvetica; color: #314053; font-size: 18px; margin-top: 10px; margin-bottom: 10px;">
                                        ...
                                        <p style="font-family: helvetica; color: #314053; font-size: 14px; margin-top: 0px; margin-bottom: 80px; font-style: italic;">
