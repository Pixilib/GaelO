<?php
    ...
    define('EI_SQL_DUMP_FILE_CREATE', 'database/database.sql');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'Open Trial Processor');
    ...
    define('EI_LICENSE_AGREEMENT_PAGE', '../LICENSE');    
   
    // *** additional text after successful installation
    define('EI_POST_INSTALLATION_TEXT', 'WARNING : DELETE MANUALLY THE INSTALL FOLDER - MENDATORY FOR SECURITY');
