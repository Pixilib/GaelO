		...
		$("#adminDialog").dialog({
			...
			beforeClose: function(event, ui) {
				if (event.originalEvent !== undefined) {
					//Closed manually
					alertify.confirm('Close?', 'Your changes will be lost', function() {
...
<div class="text-center">
	...
	<div>
		<input class="btn btn-primary" type="button" value="Add User" id="addUser">
		<input class="btn btn-primary" type="button" value="Modify center list" id="openModifyCenter">
		<input class="btn btn-primary" type="button" value="Create Study" id="openCreateStudy">
		<input class="btn btn-primary" type="button" value="Define Visit" id="defineVisit">
		<input class="btn btn-primary" type="button" value="Study Activation" id="openStudyActivation">
		<input class="btn btn-primary" type="button" value="Prefs" id="prefs">
		...
		<a href="/export_database">
			<input class="btn btn-primary" type="button" value="Export DB" id="exportDb">
		</a>
	</div>
	<br>
...
<div id="adminDisplay">
	<!------------ Study Selector ----------------------->
	<div class="text-center">
		<label>User account database of study:</label> <SELECT class="custom-select" name="Study" id="studySelector" style="width: auto;">
			<?php
