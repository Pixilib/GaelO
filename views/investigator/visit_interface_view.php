...
<script type="text/javascript">
	...
	$(document).ready(function(){
	       ...
	       <?php
            ...
            if ($role == User::REVIEWER || ($role == User::CONTROLLER && ($visitObject->stateQualityControl == Visit::QC_NOT_DONE || $visitObject->stateQualityControl == Visit::QC_WAIT_DEFINITVE_CONCLUSION))) {
                ?>
...
if ($role == User::REVIEWER || ($role == User::CONTROLLER && ($visitObject->stateQualityControl == Visit::QC_WAIT_DEFINITVE_CONCLUSION || $visitObject->stateQualityControl == Visit::QC_NOT_DONE))) {
    ?>
